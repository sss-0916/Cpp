...
int main()
{
	...
	cout << "The original vector l1 is below: " << endl;
	...
	copy(l1.begin(), l1.end(), ostream_iterator<int>(cout, ", "));
	cout << endl;
	it1 = remove_copy(l1.begin(), l1.end(), l2.begin(), 6);
	...
	l1.assign(source, source + num);
	it1 = unique_copy(l1.begin(), l1.end(), lll.begin());
	copy(lll.begin(), --it1, ostream_iterator<int>(cout, ", "));
	cout << endl;
	cout << "Unique_copy(if) the elements. " << endl;
	l1.assign(source, source + num);
	it1 = unique_copy(l1.begin(), l1.end(), lll.begin(), mylessthan);
	copy(lll.begin(), --it1, ostream_iterator<int>(cout, ", "));
	cout << endl;
	system("pause");
	return 0;
